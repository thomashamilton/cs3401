...
public class SierpinskiTriangle extends JApplet {
	...
	public SierpinskiTriangle() {
		...
		panel.add(jftOrder);
		jftOrder.setHorizontalAlignment(SwingConstants.RIGHT);
		...
		// Register a listener
		jftOrder.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				trianglePanel.setOrder(Integer.parseInt(jftOrder.getText()));
			}
		});
	}
	...
	static class SierpinskiTrianglePanel extends JPanel {
		...
		private void displayTriangles(Graphics g, int order, Point p1,
			...
			if (order == 0) {
				...
				// Recusively display three triangles
